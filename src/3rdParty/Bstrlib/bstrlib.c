...
#ifndef bstr__alloc
#define bstr__alloc(x) calloc (x,sizeof( char ))
#endif
...
/**
 * \brief Increases the size of the memory backing the bstring b to at least len.
 *
 * \param b         Source bstring.
 * \param len       Memory length.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
 */
...
/**
 * \brief Sets the size of the memory backing the bstring b to len or b->slen+1, whichever is larger.
 *
 * \param b         Source bstring.
 * \param len       Memory length.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
 * @note Repeated use of this function can degrade performance.
 */
...
/**
 * \brief Creates a bstring which contains the contents of the '\0' terminated char * buffer.
 *
 * \param str       C string buffer.
 *
 * \return If successful the bstring, otherwise returns NULL.
 *
 * @note Repeated use of this function can degrade performance.
 */
 ...
 * \brief Creates a bstring which contains the contents of the '\0' terminated char * buffer.
 *
 * \param mlen      Minimum string length.
 * \param str       C string buffer.
 *
 * \return If successful the bstring, otherwise returns NULL.
 *
 * @note The memory buffer backing the string is at least mlen characters in length.
 */
...
/**
 * \brief Creates a bstring which contains the content of the block blk of length len.
 *
 * \param blk      Minimum string length.
 * \param len      C string buffer.
 *
 * \return If successful the bstring, otherwise returns NULL.
 *
 */
...
/**
 * \brief Creates a '\0' terminated char * buffer which is equal to the contents of the bstring,
 * except that any contained '\0' characters are converted to the character in z.
 * This returned value should be freed with a bcstrfree () call, by the calling application.
 *
 * \param b        Source bstring.
 * \param z        '\0' characters conversion to character.
 *
 * \return If successful returns the C string processed, otherwise returns NULL.
 *
 */
...
/**
 *  \brief Frees a C-string generated by bstr2cstr (). This is normally unnecessary
 ...
 *  BSTRLIB_MEMORY_DEBUG) with some difference in behavior from the std
 *  library functions, then this allows a correct way of freeing the memory
 *  that allows higher level code to be independent from these macro
 *  redefinitions.
 *
 * \param s        C string to be freed.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
 */
...
/**
 * \brief Bstring concatenation.
 *
 * \param b0       Destination bstring.
 * \param b1       Source bstring.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
 */
...
/**
 * \brief Concatenate a single character to a bstring.
 *
 * \param b        Destination bstring.
 * \param c        Source char.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
...
/**
 * \brief Concatenate a C string to a bstring.
 *
 * \param b        Destination bstring.
...
/**
 * \brief Concatenate a fixed length buffer to bstring.
 *
 * \param b        Destination bstring.
 * \param s        Source fixed buffer pointer.
 * \param len      Source fixed buffer length.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
 */
...
/**
 * \brief Create a copy of a bstring.
 *
 * \param b        Source bstring.
 *
 * \return If successful a valid bstring, otherwise returns NULL.
 *
 */
...
/**
 * \brief Overwrite the bstring a with content of bstring b.
 *
 * \param a        Destination bstring.
 * \param b        Source bstring.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
...
/**
 * \brief Overwrite the bstring a with the middle of contents of bstring b
 * starting from position left and running for a length len. left and
 * len are clamped to the ends of b as with the function bmidstr.
 *
 * \param a        Destination bstring.
 * \param b        Source bstring.
 * \param left     Start position from left.
 * \param len      Length.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
...
/**
 * \brief Overwrite the string a with the contents of char * string str.  Note that
...
/**
 * \brief Overwrite the string a with the contents of the block (s, len).  Note that
 * the bstring a must be a well defined and writable bstring. If an error
 * occurs BSTR_ERR is returned and a is not overwritten.
 *
 * \param a        Destination bstring.
 * \param s        Source c string.
 * \param len      Source c length.
 *
 * \return If an error occurs BSTR_ERR is returned and a is not overwritten.
 *
 */
 ...
 *
 * \param b        Destination bstring.
 * \param n        Length to be truncated to.
 *
 * \return If successful BSTR_OK, otherwise returns BSTR_ERR.
 *
 */
...
int bstricmp ( const_bstring b0, const_bstring b1 )
{
    ...
    if ( ( n = b0->slen ) > b1->slen )
    {
        ...
        if ( b0->slen == b1->slen && b0->data == b1->data )
        {
            return BSTR_OK;
        }
 ...
 *  character is '\0', then it is taken to be the value UCHAR_MAX+1.
 */
int bstricmpcstr ( const_bstring b0, const char* s )
{
    bstring b1 = NULL;
    int result = BSTR_OK;

    b1 = bfromcstr ( s );
    result = bstricmp ( b0, b1 );
    bdestroy ( b1 );
...
/*  int bstrcmpcstr (const_bstring b0, const_bstring b1)
 *
 *  Compare the string b0 and b1.  If there is an error, SHRT_MIN is returned,
 *  otherwise a value less than or greater than zero, indicating that the
 *  string pointed to by b0 is lexicographically less than or greater than
 ...
 *  past any '\0' termination characters encountered.
 */
int bstrcmpcstr ( const_bstring b0, const char* s )
{
    bstring b1 = NULL;
    int result = BSTR_OK;

    b1 = bfromcstr ( s );
    result = bstrcmp ( b0, b1 );
    bdestroy ( b1 );
...
int binstr ( const_bstring b1, int pos, const_bstring b2 )
{
    int j = 0, ii = 0, ll = 0, lf = 0;
    unsigned char* d0 = NULL;
    unsigned char c0 = 0;
    register unsigned char* d1 = NULL;
...
/*  int binstr (const_bstring b1, int pos, const char *s)
 *
 *  Search for the bstring b2 in b1 starting from position pos, and searching
 *  forward.  If it is found then return with the first position where it is
 *  found, otherwise return BSTR_ERR.  Note that this is just a brute force
 ...
 *  this can take much longer than it needs to.
 */
int binstrcstr ( const_bstring b1, int pos, const char* s )
{
    bstring b2 = NULL;
    int result = BSTR_OK;

    b2 = bfromcstr ( s );
    result = binstr ( b1, pos, b2 );
    bdestroy ( b2 );
...
static int findreplaceengine ( bstring b, const_bstring find, const_bstring repl, int pos, instr_fnptr instr )
{
    ...
    */
    ...
    d = ( int* ) static_d;  /* Avoid calloc for trivial/initial cases */
    acc = slen = 0;
...
/*  int bfindreplacecstr (bstring b, const char * find, const char * repl,
 *                    int pos)
 *
 *  Replace all occurrences of a find string with a replace string after a
 *  given point in a c string.
 */
int bfindreplacecstr ( bstring b, const char* find, const char* repl, int pos )
{
    int result = BSTR_OK;
    bstring bfind = NULL;
    bstring brepl = NULL;

    bfind = bfromcstr ( find );
    if ( bfind == NULL )
    {
        return ( BSTR_ERR );
    }

    brepl = bfromcstr ( repl );
    if ( brepl == NULL )
    {
        return ( BSTR_ERR );
    }

    result = findreplaceengine ( b, bfind, brepl, pos, binstr );
