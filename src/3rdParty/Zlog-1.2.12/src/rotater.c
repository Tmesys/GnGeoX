...
void zlog_rotater_del ( zlog_rotater_t * a_rotater )
{
    ...
    free ( a_rotater );
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "zlog_rotater_del[%p]", a_rotater );
#endif // _DEBUG_ZLOG
    return;
}
...
#ifdef _DEBUG_ZLOG
    zlog_rotater_profile ( a_rotater, ZC_DEBUG_ZLOG );
#endif // _DEBUG_ZLOG
    return a_rotater;
err:
...
{
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "del onefile[%p]", a_file );
    zc_DEBUG_ZLOG ( "a_file->path[%s]", a_file->path );
#endif // _DEBUG_ZLOG
    free ( a_file );
}
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "zlog_rotater_file_ls_mv success" );
#endif // _DEBUG_ZLOG
