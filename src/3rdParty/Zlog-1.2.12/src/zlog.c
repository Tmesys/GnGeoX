...
int zlog_init ( const char * confpath )
{
    int rc;
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_init start------" );
    zc_DEBUG_ZLOG ( "------compile time[%s %s], version[%s]------", __DATE__, __TIME__, ZLOG_VERSION );
#endif // _DEBUG_ZLOG
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_init success end------" );
#endif // _DEBUG_ZLOG
...
int dzlog_init ( const char * confpath, const char * cname )
{
    int rc = 0;
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------dzlog_init start------" );
    zc_DEBUG_ZLOG ( "------compile time[%s %s], version[%s]------",
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------dzlog_init success end------" );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_unlock ( &zlog_env_lock );
    if ( rc )
    {
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_reload start------" );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_wrlock ( &zlog_env_lock );
    if ( rc )
    {
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_reload success, total init verison[%d] ------", zlog_env_init_version );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_unlock ( &zlog_env_lock );
    if ( rc )
    {
...
quit:
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_reload do nothing------" );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_unlock ( &zlog_env_lock );
    if ( rc )
    {
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_get_category[%s] start------", cname );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_wrlock ( &zlog_env_lock );
    if ( rc )
    {
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------zlog_get_category[%s] success, end------ ", cname );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_unlock ( &zlog_env_lock );
    if ( rc )
    {
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------dzlog_set_category[%s] start------", cname );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_wrlock ( &zlog_env_lock );
    if ( rc )
    {
...
#ifdef _DEBUG_ZLOG
    zc_DEBUG_ZLOG ( "------dzlog_set_category[%s] end, success------ ", cname );
#endif // _DEBUG_ZLOG
    rc = pthread_rwlock_unlock ( &zlog_env_lock );
    if ( rc )
    {
