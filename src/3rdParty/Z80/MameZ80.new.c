...
OP ( op, 37 )
{
    F = ( F & ( SF | ZF | YF | XF | PF ) ) | CF | ( A & ( YF | XF ) );                                                  /* SCF              */
}
